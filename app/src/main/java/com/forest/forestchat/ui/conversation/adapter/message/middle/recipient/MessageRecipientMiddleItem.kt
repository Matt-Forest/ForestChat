...
class MessageRecipientMiddleItem(
    val messageId: Long,
    val message: String,
    val hours: String,
) : BaseAdapterItem() {

    override fun getViewType(): Int = ConversationViewTypes.MESSAGE_RECIPIENT_MIDDLE

    override fun isItemTheSame(oldItem: BaseAdapterItem): Boolean =
        oldItem is MessageRecipientMiddleItem && oldItem.messageId == messageId
